...
p3.1<-read_excel(fileList[75])
p3.10<-read_excel(fileList[76])
p3.11<-read_excel(fileList[77])
p3.12<-read_excel(fileList[78])
p3.13<-read_excel(fileList[79])
p3.14<-read_excel(fileList[80])
p3.15<-read_excel(fileList[81])
p3.16<-read_excel(fileList[82])
p3.18<-read_excel(fileList[83])
p3.19<-read_excel(fileList[84])
p3.2<-read_excel(fileList[85])
p3.20<-read_excel(fileList[86])
p3.26<-read_excel(fileList[87])
p3.3<-read_excel(fileList[88])
p3.37<-read_excel(fileList[89])
p3.38<-read_excel(fileList[90])
p3.39<-read_excel(fileList[91])
p3.4<-read_excel(fileList[92])
p3.40<-read_excel(fileList[93])
p3.41<-read_excel(fileList[94])
p3.42<-read_excel(fileList[95])
p3.43<-read_excel(fileList[96])
p3.44<-read_excel(fileList[97])
p3.5<-read_excel(fileList[98])
p3.50<-read_excel(fileList[99])
p3.52<-read_excel(fileList[100])
p3.6<-read_excel(fileList[101])
p3.7<-read_excel(fileList[102])
p3.8<-read_excel(fileList[103])
p3.9<-read_excel(fileList[104])
...
p5.21<-read_excel(fileList[105])
p8.10<-read_excel(fileList[106])
p8.11<-read_excel(fileList[107])
p8.13<-read_excel(fileList[108])
p8.14<-read_excel(fileList[109])
p8.17<-read_excel(fileList[110])
p8.19<-read_excel(fileList[111])
p8.20<-read_excel(fileList[112])
p8.21<-read_excel(fileList[113])
p8.22<-read_excel(fileList[114])
p8.23<-read_excel(fileList[115])
p8.36<-read_excel(fileList[116])
p8.38<-read_excel(fileList[117])
p8.39<-read_excel(fileList[118])
p8.48<-read_excel(fileList[119])
p8.49<-read_excel(fileList[120])
p8.51<-read_excel(fileList[121])
p8.53<-read_excel(fileList[122])
p8.57<-read_excel(fileList[123])
p8.61<-read_excel(fileList[124])
p8.71<-read_excel(fileList[125])
p8.72<-read_excel(fileList[126])
p8.8<-read_excel(fileList[127])
p8.9<-read_excel(fileList[128])
...
p9.11<-read_excel(fileList[129])
p9.15<-read_excel(fileList[130])
p9.16<-read_excel(fileList[131])
p9.17<-read_excel(fileList[132])
p9.18<-read_excel(fileList[133])
p9.21<-read_excel(fileList[134])
p9.22<-read_excel(fileList[135])
p9.34<-read_excel(fileList[136])
p9.35<-read_excel(fileList[137])
p9.36<-read_excel(fileList[138])
p9.52<-read_excel(fileList[139])
p9.57<-read_excel(fileList[140])
p9.6<-read_excel(fileList[141])
p9.63<-read_excel(fileList[142])
p9.64<-read_excel(fileList[143])
...
p16.10 <-read_excel(fileList[262])
p16.11 <-read_excel(fileList[263])
p16.12 <-read_excel(fileList[264])
p16.13 <-read_excel(fileList[265])
p16.14 <-read_excel(fileList[266])
p16.15 <-read_excel(fileList[267])
p16.17 <-read_excel(fileList[268])
p16.18 <-read_excel(fileList[269])
p16.19 <-read_excel(fileList[270])
p16.2 <-read_excel(fileList[271])
p16.24 <-read_excel(fileList[272])
p16.25 <-read_excel(fileList[273])
p16.3 <-read_excel(fileList[274])
p17.1 <-read_excel(fileList[275])
